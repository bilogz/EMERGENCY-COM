...
$filipinoTranslations = [
    ...
    // Login Page
    'login.title' => 'Pag-login ng User',
    'login.instruction' => 'Mag-login gamit ang iyong nakarehistro na numero ng telepono at buong pangalan.',
    'login.fullName' => 'Buong Pangalan',
    'login.mobileNumber' => 'Numero ng Mobile',
    'login.mobileHint' => 'Ilagay ang iyong 10-digit na numero ng mobile (walang espasyo)',
    'login.smsHint' => 'Magpapadala kami ng verification code sa pamamagitan ng SMS',
    'login.sendOTP' => 'Ipadala ang OTP',
    'login.backToLogin' => 'Bumalik sa Regular Login',
